...
################################################################
# This is a generated script based on design: averageBlockDesign_wClock
#
...
# source averageBlockDesign_wClock_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# averageToRam, PWM_Dynamic
...
set design_name averageBlockDesign_wClock
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set adcIn [ create_bd_port -dir I -from 14 -to 0 adcIn ]
  set pmodA_1 [ create_bd_port -dir O pmodA_1 ]
...
\
  ...
  # Create instance: averageToRam_0, and set properties
  set block_name averageToRam
  set block_cell_name averageToRam_0
  if { [catch {set averageToRam_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $averageToRam_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.numofbit {15} $averageToRam_0
  ...
  # Create instance: PWM_Dynamic_0, and set properties
  set block_name PWM_Dynamic
  set block_cell_name PWM_Dynamic_0
  if { [catch {set PWM_Dynamic_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $PWM_Dynamic_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net PWM_Dynamic_0_pwm_out  [get_bd_pins PWM_Dynamic_0/pwm_out] \
  [get_bd_ports pmodA_1]
  connect_bd_net -net adcIn_1  [get_bd_ports adcIn] \
  [get_bd_pins averageToRam_0/encoderdatain]
  connect_bd_net -net averageToRam_0_addrb  [get_bd_pins averageToRam_0/addrb] \
  [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net averageToRam_0_enb  [get_bd_pins averageToRam_0/enb] \
  [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net averageToRam_0_outencodeddatatoram  [get_bd_pins averageToRam_0/outencodeddatatoram] \
  [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net averageToRam_0_web  [get_bd_pins averageToRam_0/web] \
  [get_bd_pins blk_mem_gen_0/web]
  connect_bd_net -net axi_gpio_0_gpio_io_o  [get_bd_pins axi_gpio_0/gpio_io_o] \
  [get_bd_pins averageToRam_0/enable]
  connect_bd_net -net axi_gpio_1_gpio2_io_o  [get_bd_pins axi_gpio_1/gpio2_io_o] \
  [get_bd_pins PWM_Dynamic_0/duty_cycles]
  connect_bd_net -net axi_gpio_1_gpio_io_o  [get_bd_pins axi_gpio_1/gpio_io_o] \
  [get_bd_pins PWM_Dynamic_0/period_cycles]
  ...
  [get_bd_pins averageToRam_0/clk] \
  [get_bd_pins axi_gpio_1/s_axi_aclk] \
  [get_bd_pins PWM_Dynamic_0/clk]
  ...
  [get_bd_pins averageToRam_0/reset] \
  [get_bd_pins axi_gpio_1/s_axi_aresetn] \
  [get_bd_pins PWM_Dynamic_0/reset]
